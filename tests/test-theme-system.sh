...
assert_in_order "Roadmap fixes critical context before candidate verification, canary, and publication" "$SUPERVISED_ROADMAP" "issues/25" "issues/19" "issues/16" "issues/17"
