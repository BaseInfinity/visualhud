...
- [ ] **PostToolUse / PostToolUseFailure migration** — success-weighted counter (no more bumps on failed tool calls) + per-tool error flash; planned for v1.1 with backwards compat for older hook registrations
