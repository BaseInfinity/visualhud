...
assert_contains "Publish verifies registry version" "npm|view visualhud@0.1.3 version" "$publish_log"
assert_contains "Publish output confirms registry version" "Published visualhud@0.1.3." "$publish_output"
echo ""
