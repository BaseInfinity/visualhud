...
assert_contains "Publish verifies registry version" "npm|view visualhud@1.1.0 version" "$publish_log"
assert_contains "Publish output confirms registry version" "Published visualhud@1.1.0." "$publish_output"
echo ""
