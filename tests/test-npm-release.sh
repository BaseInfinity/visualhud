...
assert_contains "Publish verifies registry version" "npm|view visualhud@0.1.2 version" "$publish_log"
assert_contains "Publish output confirms registry version" "Published visualhud@0.1.2." "$publish_output"
echo ""
