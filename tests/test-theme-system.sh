...
assert_in_order "Roadmap prioritizes Codex delivery context and state clarity before theme expansion" "$ROADMAP_DOC" "## Priority 2 - Build v1.3.0" "issues/23" "issues/4" "issues/12" "issues/14" "issues/13"
